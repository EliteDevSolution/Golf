...
if(isset($_POST['email'])){
  ...
  $sql = "INSERT INTO `tempahan`(`user_email`, `padanggolf`, `masa`, `tarikh`, `method`, `bank`) VALUES ('$a','$b','$e','$f','$c','$d')";
              ...
              <nav class="navbar navbar-expand-lg navbar-light tm-bg-white-transparent tm-navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
                      <a class="nav-link" href="field.php">Golf Field</a>
                    </li>
              ...
              <div class="col-lg-8 tm-contact-col-left">
                <form action="#" method="POST" id="tmContactForm" class="tm-bg-black-transparent tm-contact-form">
                  ...
                  <div class="form-group">
                    <input type="email" id="contact_email" name="email" class="form-control rounded-0 border-top-0 border-right-0 border-left-0" placeholder="Enter your email" required>
                  </div>
                  ...
                  <select name="jenis" required>
                    ...
                    <option value="Dessert">Dessert Course</option>
                ...
                <div class="form-group">
                  <label>Date: </label>
                  <input type="date" min="2021-01-01" max="2021-12-31" name="tarikh" required>
                </div>

                   <div class="form-group">
                  <label>Time Period: </label>
                  <input type="time" min="09:00" max="17:00" name="masa" required>
                   </input>
                 </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="method" id="inlineRadio1" value="Online Banking" required>
                      <label class="form-check-label" for="inlineRadio1">Online Banking</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="method" id="inlineRadio2" value="Cash" required>
